...
<head>
    ...
    <title>Isdaan Ni Lynde | Products</title>
...
<body>
    ...
    <!-- Contact & My Orders -->
    <div class="logout" style="display: flex; align-items: center; gap: 20px; padding: 10px 20px;">
        <div class="cntct" style="color: black; font-weight: bold; font-style: italic;">
            <p><strong>Contact Number:</strong> 0950-7707-934</p>
        </div>
        <div class="my-orders-btn" style="margin: 0;">
            <a href="my_orders.php?contact=09507707934" class="primary-button">My Orders</a>
        </div>
    </div>
