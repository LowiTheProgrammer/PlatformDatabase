...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $conn = new mysqli("localhost", "root", "", "isdaan_db"); 
    // ❗ Replace "isdaan" with your real database name 
    ...
    // 3. Insert query
    $sql = "INSERT INTO inquiries (first_name, last_name, email, contact, message)
            VALUES (?, ?, ?, ?, ?)";
...
<head>
  ...
  <title>Isdaan Ni Lynde | Thank You!</title>
...
<!-- Main Content -->
  ...
  <section id="thank-you">
    <h1>Thank You!</h1>
    <p>Your form has been successfully submitted. We’ll be in touch with you shortly.</p>
    <a href="./home.php">
      <button class="primary-button">Return to Homepage</button>
    </a>
  </section>
</main>
