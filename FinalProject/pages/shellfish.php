...
<head>
  ...
  <title>Isdaan Ni Lynde | Shellfish Products</title>
...
<body>
  ...
  <section class="product-section">
    <h2>Our Shellfish Products</h2>
    <div class="product-container">

      <div class="product-card">
        <img src="../assets/images/Crab.jfif" alt="Crab">
        <h3>Crab</h3>
        <p>Fresh, meaty crab perfect for steaming, chili crab, or ginataang alimasag.</p>
        <form action="checkout.php" method="get">
          <input type="hidden" name="product" value="Crab">
          <button type="submit" class="primary-button">Buy Now!</button>
        </form>
      </div>

      <div class="product-card">
        <img src="../assets/images/shrimp.jfif" alt="Shrimp">
        <h3>Shrimp</h3>
        <p>Juicy, freshly caught shrimp ideal for grilling, sinigang, or tempura.</p>
        <form action="checkout.php" method="get">
          <input type="hidden" name="product" value="Shrimp">
          <button type="submit" class="primary-button">Buy Now!</button>
        </form>
      </div>
